...
class DetailHamaTikusScreen extends StatelessWidget {
  const DetailHamaTikusScreen({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Cara Menanggulangi Hama Tikus pada Tanaman Padi',
                style: TextStyle(
                  fontSize: 24,
